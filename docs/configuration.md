...
| `HBAR_SPENDING_PLANS_CONFIG_FILE`           | "spendingPlansConfig.json" | The path to the JSON file containing the pre-configured spending plans for supported projects and partner projects.                                                                                                                                                                                    |
