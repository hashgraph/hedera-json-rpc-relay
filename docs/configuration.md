...
| `HBAR_DAILY_TOTAL_BUDGET`                   | "158400"                 | daily total budget of the HBAR limiter                                                                                                                                                                                                                                                                 |
| `HBAR_DAILY_LIMIT_BASIC`                    | "1000"                   | daily limit for HBAR spending plans with a BASIC tier.                                                                                                                                                                                                                                                 |
| `HBAR_DAILY_LIMIT_EXTENDED`                 | "10000"                  | daily limit for HBAR spending plans with a EXTENDED tier.                                                                                                                                                                                                                                              |
| `HBAR_DAILY_LIMIT_PRIVILEGED`               | "20000"                  | daily limit for HBAR spending plans with a PRIVILEGED tier.                                                                                                                                                                                                                                            |
