...
| `CLIENT_TRANSACTION_RESET`            | "50"          | Number of transaction executions, until client reinitialization.                                                                                                                                                                                                                                       |
| `CLIENT_DURATION_RESET`               | "3600000"     | Time until client reinitialization. (ms)                                                                                                                                                                                                                                                               |
