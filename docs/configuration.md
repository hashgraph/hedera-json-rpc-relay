...
| `METHOD_CONFIGURATION_OVERRIDE`             | ""            | JSON to override method configuration, both rate limit and cacheTTL, if cacheTTL is missing or 0, is as caching for method is disabled. totalLimit is in units, cacheTTL is in ms. example: '{ "net_version" : { "cacheTTL" : "300"}, "eth_getBlockByHash" : { "cacheTTL" : "300"} }'                                                                                                           |
