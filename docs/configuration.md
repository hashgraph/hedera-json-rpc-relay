...
| `HBAR_SPENDING_PLANS_CONFIG`                | "" | The environment variable that either points to a file containing the spending plans, or the JSON content defining the spending plans.                                                                                                                                                                                    |
