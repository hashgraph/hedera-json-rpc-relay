...
| `CLIENT_TRANSACTION_RESET`            | "400000"      | Number of transaction executions, until client reinitialization.                                                                                                                                                                                                                                       |
| `CLIENT_DURATION_RESET`               | "21600000"    | Time until client reinitialization. (ms)                                                                                                                                                                                                                                                               |
| `CLIENT_ERROR_RESET`                  | "100"         | Number of error to be reached, until client reinitialization.                                                                                                                                                                                                                                          |
