...
| Name                                  | Default       | Description                                                                                                                                                                                                                                                                                            |
| ------------------------------------- | ------------- |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `ESTIMATE_GAS_THROWS`                 | "true"        | eth_estimateGase throws an error if the encoded contract is bigger than 12288 bytes when posting to the mirror node.  Set this to true to ignore.
