...
| `HBAR_RATE_LIMIT_BASIC`                     | "1000"                   | Individual limit for hbar spending plans with a BASIC tier.                                                                                                                                                                                                                                            |
| `HBAR_RATE_LIMIT_EXTENDED`                  | "10000"                  | Individual limit for hbar spending plans with a EXTENDED tier.                                                                                                                                                                                                                                         |
| `HBAR_RATE_LIMIT_PRIVILEGED`                | "20000"                  | Individual limit for hbar spending plans with a PRIVILEGED tier.                                                                                                                                                                                                                                       |
