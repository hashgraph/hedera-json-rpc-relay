...
| MIRROR_BASE_URL | The URL for the mirror node to use. ie: https://testnet.mirrornode.hedera.com                                                                                                                                                                                                                                                                                               |               | true     |
| RELAY_BASE_URL | The URL of the RCP-Relay to perform the Tests against. ie: https://testnet.hashio.io/api                                                                                                                                                                                                                                                                                    |               | true     | 
| DEFAULT_DURATION | Duration of each test, K6 will perform as many requests as possible for each test in this given timeframe.  Some tests might overrride this duration to a minimun for at least 1 sucessful call for that test. ie: if DEFAULT_DURATION=1s, but eth_sendRawTransaction needs atleast 3s, k6 will use the bigger of the 2 (3s). to try to guarantee at least 1 sucessful call | 120s          | false | 
...
| FILTER_TEST | Test or Tests to be run, separated by comma without blanks ie: "eth_call", "eth_call,eth_chainId,eth_sendRawTransaction"                                                                                                                                                                                                                                                    | *             | false |
