...
export default {
  ...
  HBAR_RATE_LIMIT_TOTAL: Hbar.fromTinybars(process.env.HBAR_RATE_LIMIT_TINYBAR || '11000000000'),
  HBAR_RATE_LIMIT_BASIC: Hbar.from(BigNumber(process.env.HBAR_DAILY_LIMIT_BASIC || '1000'), HbarUnit.Hbar),
  HBAR_RATE_LIMIT_EXTENDED: Hbar.from(BigNumber(process.env.HBAR_DAILY_LIMIT_EXTENDED || '10000'), HbarUnit.Hbar),
  HBAR_RATE_LIMIT_PRIVILEGED: Hbar.from(BigNumber(process.env.HBAR_DAILY_LIMIT_PRIVILEGED || '20000'), HbarUnit.Hbar),
