...
export default {
  ...
  HBAR_RATE_LIMIT_TOTAL: Hbar.fromTinybars(BigNumber(process.env.HBAR_RATE_LIMIT_TINYBAR || '11000000000')), // 110 HBARs per 80 seconds
  HBAR_RATE_LIMIT_BASIC: Hbar.fromTinybars(BigNumber(process.env.HBAR_DAILY_LIMIT_BASIC || '92592592')), // Equivalent of 1000 HBARs per day
  HBAR_RATE_LIMIT_EXTENDED: Hbar.fromTinybars(BigNumber(process.env.HBAR_DAILY_LIMIT_EXTENDED || '925925925')), // Equivalent of 10000 HBARs per day
  HBAR_RATE_LIMIT_PRIVILEGED: Hbar.fromTinybars(BigNumber(process.env.HBAR_DAILY_LIMIT_PRIVILEGED || '1851851850')), // Equivalent of 20000 HBARs per day
