...
describe('Parity', async function() {
    it(`should execute "parity_nextNonce" and return unsupported message`, async function () {
        const result = await Relay.parity().nextNonce();
