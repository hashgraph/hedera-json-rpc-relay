...
describe('@api-batch-3 RPC Server Acceptance Tests', function () {
  ...
  describe('Debug API Test Suite', async function () {
    ...
    describe('Positive scenarios', async function () {
      it('should be able to debug a transaction with call depth and onlyTopCall false', async function () {
        ...
        const signedTransaction = await accounts[0].wallet.signTransaction(estimateGasContractCreationTransaction);
