...
describe('@api-batch-3 RPC Server Acceptance Tests', function () {
  ...
  describe('Debug API Test Suite', async function () {
    ...
    const successfulResultType2930 = {
      from: '0x00000000000000000000000000000000000007c7',
      to: '0x00000000000000000000000000000000000007cd',
      value: '0x1',
      gas: '0x2dc6c0',
    ...
    describe('Positive scenarios', async function () {
      ...
      it('should be able to debug a successful CALL transaction of type Legacy with call depth and onlyTopCall false', async function () {
        ...
        //await Assertions.assertTransactionDebugResponse(resultDebug, SuccessResultCallTypeLegacyOnlyTopCallFalse, tracerConfigFalse);
      });
      //how can I make a create contract trx fail? invalid chainId?
      it.only('should be able to debug a failing CREATE transaction of type Legacy with call depth and onlyTopCall false', async function () {
        const transaction = {
          ...transactionTypeLegacy,
          to: null,
          from: accounts[2].address,
      ...
      it('should be able to debug a failing CALL transaction of type Legacy with call depth and onlyTopCall false', async function () {
        let signedTransaction = await accounts[2].wallet.signTransaction(failingTransactionTypeLegacy);
        let transactionHash = await relay.sendRawTransaction(signedTransaction, requestId);
      ...
      it.skip('should be able to debug a successful CALL transaction of type 2930 with call depth and onlyTopCall false', async function () {
        const transaction = {
          ...transactionType2930,
          gasPrice: await relay.gasPrice(requestId),
        };
      ...
      it.skip('should be able to debug a failing CALL transaction of type 2930 with call depth and onlyTopCall false', async function () {
        let signedTransaction = await accounts[2].wallet.signTransaction(transactionType2930);
        let transactionHash = await relay.sendRawTransaction(signedTransaction, requestId);
        const resultDebug = await relay.call(
          RelayCalls.ETH_ENDPOINTS.DEBUG_TRACE_TRANSACTION,
      ...
      it('should be able to debug a successful CREATE transaction of type 2 with call depth and onlyTopCall false', async function () {
        ...
        //expect(resultDebug).to.deep.eq(expectedResult.result);
        await Assertions.assertTransactionDebugResponse(resultDebug, expectedResult.result, tracerConfigFalse);
      });

      //Invalid Argument
      it.skip('should be able to debug a successful CALL transaction of type 2 with call depth and onlyTopCall false', async function () {
        const transaction = {
          ...estimateGasContractCreationTransaction,
          from: accounts[1].address,
          to: mirrorContract.evm_address,
        ...
        let signedTransaction = await accounts[1].wallet.signTransaction(estimateGasContractCreationTransaction);
        let transactionHash = await relay.sendRawTransaction(signedTransaction, requestId);
      ...
      it('should be able to debug a failing CREATE transaction of type 2 with call depth and onlyTopCall false', async function () {
