...
export default {
    ETH_ENDPOINTS, HTS_CONTRACT_EVENTS, GAS, NON_EXISTING_ADDRESS, NON_EXISTING_TX_HASH, NON_EXISTING_BLOCK_HASH, NON_EXISTING_BLOCK_NUMBER,
    NON_EXISTING_INDEX, ZERO_HEX, CALL_EXCEPTION
}