...
// bumping version using replace for 'packages/env-provider/package.json', 'packages/relay/package.json', 'packages/server/package.json', 'docs/openrpc.json', 'packages/ws-server/package.json'
...
replace({
  ...
  paths: [
    "packages/env-provider/package.json",
